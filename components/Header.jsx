      ...
      <Wrapper className="h-[60px] flex justify-between items-center">
        ...
        <div className="flex items-center gap-2 text-black">
          ...
          >
            ...
            {userDropdownVisible && (
              <div className="absolute top-12 right-0 mt-2 bg-white border border-gray-300 rounded-md shadow-lg">
                <ul>
                  <li className="py-2 px-4 cursor-pointer hover:bg-gray-100">
                    <Link href="/orders" className="whitespace-nowrap">Order Details</Link>
                  </li>
                  <li className="py-2 px-4 cursor-pointer hover:bg-gray-100">
                    <Link href="/contact" className="whitespace-nowrap">Talk with Us</Link>
                  </li>
                </ul>
              </div>
            )}
